...
sys.stdout.write('\x1b]2; ZMBF | ZhuL Multi Brute Facebook\x07')
#------------------[ USER-AGENT ]-------------------#
try:
	prox= requests.get('https://api.proxyscrape.com/v2/?request=displayproxies&protocol=socks4&timeout=80000&country=all&ssl=all&anonymity=all').text
	open('.prox.txt','w').write(prox)
except Exception as e:
	print(' [+] Koneksi Internet Anda Tidak Terdeteksi Silahkan Cek Kuota Anda Ya Salam Dari ZhuL')
...
for t in range(10000):
	rr = random.randint
	samsung=random.choice(['SM-J415N','SM-J610G','CPH2109','SM-M236B','SM-J610F','SM-J410G','SM-A536E','MI A3','MI 9T PRO','VIVO Y22','Vivo 1917'])
...
def bot():
	...
	if bray in('1','01'):
		...
		os.system("xdg-open https://wa.me/+6285336393488?text=Selamat+Pagi+Bang+Saya+Mau+Melaporkan+Bug+Pada+Sc+Mu+Bang")
		time.sleep(3)
		exit()
